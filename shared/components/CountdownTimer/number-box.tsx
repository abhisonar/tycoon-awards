  ...
  return (
    <div className="flex flex-col items-center px-2">
      <div className=" relative bg-transparent flex flex-col items-center justify-center rounded-12 w-9 h-9 md:w-11 md:h-11 lg:w-14 lg:h-14 text-2xl md:text-4xl mt-4 ">
        ...
        <div className="text-xl absolute text-primary-default z-10 font-bold font-redhat md:text-2xl font-mono ">
          {num}
        </div>

        <div className=" rounded-lg rounded-lg bg-[#2c2e3f] w-full h-full"></div>

        <div
          className={`absolute w-full h-1/2 top-0 rounded-lg z-5 ${
            flip ? "animate-flip bg-primary-lighter" : "bg-transparent"
          }`}></div>
      </div>
