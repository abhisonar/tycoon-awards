    ...
    return (
        <div className="min-w-full min-h-full z-0 relative">
            <div className="flex flex-col min-w-full min-h-full lg:min-h-screen">
                {
                    eventDetail?.isVideo ? (
                        <video loop={true} autoPlay={true} muted={true} className="w-full h-full object-fill" controls preload={'auto'}>
                            <source src={eventDetail.posterSrc} type="video/mp4"/>
            ...
            <div
                className="flex flex-col w-full lg:absolute lg:bottom-[0px]  bg-gradient-radial lg:from-darkBlack to-transparent justify-center items-center">
                <div
                    className="flex flex-col md:flex-row gap-5 w-full px-4 lg:px-20 py-4 lg:py-10 justify-center items-center">
